...
ВАЖНО: При анализе учитывай следующие критерии:
1. Название поставщика в заголовке должно точно соответствовать "${supplierName}"
2. Результаты НЕ обязательно должны быть для региона Вена/Австрия - глобальные предложения тоже валидны
3. НЕ игнорируй результаты для других регионов - кэшбек и купоны часто глобальные
4. НЕ ПРИДУМЫВАЙ И НЕ ИСПОЛЬЗУЙ ФОЛБЕКИ - если информации нет, скажи что нет
5. ВНИМАТЕЛЬНО АНАЛИЗИРУЙ ВСЕ РЕЗУЛЬТАТЫ: ищи любые упоминания кэшбека, скидок, купонов, промокодов
6. ИЗВЛЕКАЙ ПРОЦЕНТЫ И СУММЫ: ищи любые числовые значения скидок и кэшбека
7. БУДЬ ТЩАТЕЛЬНЫМ: проанализируй все доступные результаты поиска
